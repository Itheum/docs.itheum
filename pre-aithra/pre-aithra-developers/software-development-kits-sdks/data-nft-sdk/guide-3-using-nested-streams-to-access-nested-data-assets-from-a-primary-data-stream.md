...
Your Data Stream could be hosted by any of the data hosting service options provided in[data-streams-guides](../../../pre-aithra-integrators/data-streams-guides/ "mention"). If you are not requiring the behaviour of a "nested stream", you do not need to do anything extra above hosting your data and making it available as a public URL. But in the event you do need to configure your Data Stream as a nested stream, then your backend Data Stream server will need to send down a custom [HTTP Response Header](https://developer.mozilla.org/en-US/docs/Glossary/Response_header).
...
* The `file` should be a public URL that follows the standard [data-stream-url-rules.md](../../../pre-aithra-integrators/data-streams-guides/data-stream-url-rules.md "mention")
